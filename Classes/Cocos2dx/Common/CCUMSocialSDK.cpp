...
void CCUMSocialSDK::setMessageTypeImage()
{
#if CC_TARGET_PLATFORM == CC_PLATFORM_IOS
    UmSocialControllerIOS::setMessageTypeImage();
#endif
}

void CCUMSocialSDK::setMessageTypeWeb()
{
#if CC_TARGET_PLATFORM == CC_PLATFORM_IOS
    UmSocialControllerIOS::setMessageTypeWeb();
#endif
}
