...
protected:
	...
	SHZIClientUserItem *				mIClientUserItem[MAX_CHAIR];		//用户信息

	//组件接口
protected:
	SHZITableViewFrame *				mITableViewFrame;					//桌子接口
...
//数组定义
typedef std::vector<SHZCTableView *>		CTableViewArray_SHZ;					//桌子数组
...
protected:
	...
	//控件变量
public:
	CTableViewArray_SHZ					mTableViewArray;					//桌子数组
